...
export async function POST(request, response) {
    ...
    const result = await sendPostRequest('https://turbobroker.ru/api/update-users-rights', { users: JSON.parse(formData.get("users")), groups: JSON.parse(formData.get("groups")) })
