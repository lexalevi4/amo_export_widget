...
function BaseObjectsTable({ objects, showCaption = true, objectsIsLoading = false, setObjectForEdit = () => { } }) {
    ...
    if (objects.length === 0 && !objectsIsLoading) {
        return (
            <Typography
                level="title-lg"
            >
        ...
        >
            ...
            >
                ...
                {!objectsIsLoading && objects.map(object => {
                    ...
                    return (
                        <BaseObjectsTableRow
                            setObjectForEdit={() => setObjectForEdit(object)}
                            object={object}
